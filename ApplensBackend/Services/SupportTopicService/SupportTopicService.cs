...
namespace AppLensV3.Services
{
    public class SupportTopicService: ISupportTopicService
    {
        ...
        cluster('azsupportfollower.westus2.kusto.windows.net').database('AzureSupportability').ActiveSupportTopicTree
        ...
        public async Task<List<SupportTopic>> GetSupportTopicsAsync(string productId)
        {
            ...
            DataTable dt = await _kustoQueryService.ExecuteQueryAsync("azsupportfollower.westus2.kusto.windows.net", "AzureSupportability", kustoQuery);
